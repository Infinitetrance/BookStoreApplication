...
public class ADFUtils {
    ...
    public static OperationBinding executeOperationBinding(String operationName) {
        BindingContainer bc =
            BindingContext.getCurrent().getCurrentBindingsEntry();
        OperationBinding op = bc.getOperationBinding(operationName);
        op.execute();
        return op;
    }

    public static void addFacesMessage(String componentId,
                                       FacesMessage.Severity /*severity*/FacesMessage,
                                       String message) {
    ...
    public static void addFacesMessage(FacesMessage.Severity /*severity*/FacesMessage,
                                       String message) {
        addFacesMessage(null, FacesMessage, message);
    }
